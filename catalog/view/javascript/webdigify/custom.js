...
$(document).ready(function(){
	...
	jQuery(".popup_overlay .play-icone").click(function() {
...
function menuResponsive(){
	...
	if ($(window).width() < 992)
	{
		...
		$('.header_bottom #header-bottom').insertAfter('.header_top .header_top_inner .header-logo');
	}else{
		$('#menu').css('display','block');
		...
		$('.header_top .header_top_inner .account .drop_account .lang-curr-wrapper').appendTo('.header_nav .right-nav');
		...
		$('.header_top .header_top_inner #header-bottom').insertBefore('.header_bottom .header_search');
